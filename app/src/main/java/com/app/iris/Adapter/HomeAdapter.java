...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.ViewHolder> {
    ...
    public HomeAdapter(Context context, List<MainModel> applyLeaveList, ButtonClickInterface buttonClickInterface) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.single_home, viewGroup, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
       ...
       float radius = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, mContext.getResources().getDimension(R.dimen._15sdp), mContext.getResources().getDisplayMetrics());
        ...
        holder.tv_sub_title.setText(mApplyLeaveList.get(position).getSubTitle());
        holder.tv_try_now.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView tv_title, tv_sub_title, tv_try_now;
